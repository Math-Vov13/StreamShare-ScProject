...
router.get("/", validate_token_1.validate_user_token, (0, data_validation_1.body_data_validation)(content_schema_1.get_content_schema), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (Object.keys(req.body).length == 0) {
        res.status(200).json({ type: "media/Trends", response: yield (0, media_func_1.search_trends)() });
    ...
    if (!req.body.FulfilName && (((_a = req.body.Genres) === null || _a === void 0 ? void 0 : _a.length) || Array().length) == 0 && (((_b = req.body.Tags) === null || _b === void 0 ? void 0 : _b.length) || Array().length) == 0) {
        res.status(200).json({ type: "media/Trends", response: yield (0, media_func_1.search_trends)() });
    ...
    let contents = yield (0, media_func_1.search_content)(req.body.FulfilName, req.body.Genres, req.body.Tags);
...
router.get("/:content_id", validate_token_1.validate_user_token, validate_content_id_1.validate_content_id, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    res.json({ response: yield (0, media_func_1.get_content_by_id)(content_id) });
}));
